...
printDiv() 
{
 ...
 this.filtered= this.filtered.filter(elem => elem.day=="Half-day")
}
else{
...
this.filtered= this.items.filter(elem => elem.day=="Half-day")
 ...
 if(this.day == "Full-day" && this.sixth == false){
  ...
  this.filtered= this.filtered.filter(elem => elem.day=="Full-day")
      ...
      if(this.fourth== true || this.fifth == true || this.sixth == true){
        if(this.second == false && this.third == false){
          ...
          if (this.fourth == true && this.sixth == false){
            ...
            console.log(this.filtered)
            console.log(filter)
            filter.map(elem => {this.filtered.map(element => {  
        ...
        if(this.day == "Half-day"){let temp2 = temp.filter(elem => elem.day = "Half-day")
        temp2.map(elem => this.filtered.push(elem))
       }
        if(this.day == "Full-day"){let temp2 = temp.filter(elem => elem.day = "Full-day")
        temp2.map(elem => this.filtered.push(elem))
      }
