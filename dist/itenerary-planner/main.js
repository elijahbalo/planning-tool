...
var BrowsePageComponent = /** @class */ (function () {
    ...
    BrowsePageComponent.prototype.setItem = function (event) {
        var index = this.itineraries.indexOf(0);
        if (index > -1) {
