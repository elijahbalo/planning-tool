...
var LandingPageComponent = /** @class */ (function () {
    ...
    LandingPageComponent.prototype.applyFilters = function () {
        ...
        if ((this.grades == "empty")) {
            ...
            this.filtered = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](this.items, lodash__WEBPACK_IMPORTED_MODULE_3__["conforms"](this.filters));
        }
        console.log(this.filtered);
    };
    LandingPageComponent.prototype.applyFilters1 = function () {
        console.log('action called');
        this.filtered = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](this.items, lodash__WEBPACK_IMPORTED_MODULE_3__["conforms"](this.filters));
        console.log(this.filtered);
    };
    LandingPageComponent.prototype.applyFilters2 = function () {
        console.log('action called');
        this.filtered = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](this.items, lodash__WEBPACK_IMPORTED_MODULE_3__["conforms"](this.filters));
        console.log(this.filtered);
    };
    ...
    LandingPageComponent.prototype.filterExact1 = function (property, rule) {
        this.filters[property] = function (val) { return val == rule; };
        this.applyFilters1();
    };
    LandingPageComponent.prototype.filterExact2 = function (property, rule) {
        this.filters[property] = function (val) { return val == rule; };
        this.applyFilters2();
    };
