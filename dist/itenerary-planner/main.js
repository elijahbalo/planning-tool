...
var ActivityDisplayComponent = /** @class */ (function () {
    ...
    ActivityDisplayComponent.prototype.timeOfDay = function (data, length) {
        var index;
        var h = "";
        var m = "";
        for (var i = 0; i < data.length; i++) {
